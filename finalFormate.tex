...
% === PACKAGES ===
\usepackage[paperwidth=595pt, paperheight=841pt, margin=45pt, top=75pt, bottom=90pt]{geometry}
\usepackage{fontspec}
\usepackage{Archivo Narrow}
...
\fancypagestyle{firstpage}{
    ...
    \fancyhead[R]{%
        \fontsize{13.9999}{16.8}\selectfont\color{color_100238}\textbf{\VAR{journalName}}
    }
